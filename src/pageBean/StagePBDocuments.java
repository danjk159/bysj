...
public class StagePBDocuments {
	...
	public StagePBDocuments() {
	}


	public StagePBDocuments(ArrayList arrayList, String pass_sort_id) {
	...
	public String getDescriptionsip(String searchName) {
		...
		if (this.isHasPreviousPage()) {
			description = description + " <a href='" + strUrl
					+ "?page=1&Id="+searchName+"&method=search'>首页</a>";
		} else {
		...
		if (this.isHasPreviousPage()) {
			description = description + " <a href='" + strUrl
					+ "?page="+(currentPage-1)+"&Id="+searchName+"&method=search'>上一页</a>";
		...
		if (this.isHasNextPage()) {
			description = description + " <a href='" + strUrl
					+ "?page="+(currentPage+1)+"&Id="+searchName+"&method=search'>下一页</a>";
		...
		if (this.isHasNextPage()) {
			description = description + " <a href='" + strUrl
					+ "?page="+(getTotalPages())+"&Id="+searchName+"&method=search'>尾页</a>";
		...
		description = description
				...
				+ strUrl + "?method=search&Id="+searchName+"&page='+this.options[this.selectedIndex].value;>";
